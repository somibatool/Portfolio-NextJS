...
import MenuOvarlay from "./menuOvarlay"
const navLinks =[
    {
        title :"About ",
        path: "#about",
...
const [navbarOpen , setNavbarOpen] = useState(false);
  ...
  return (
    <nav className='fixed top-0 left-0 right-0  bg-[#121212] bg-opacity-100 z-50'>
        <div className='flex flex-wrap items-center justify-between mx-auto px-4 py-2 '>
           < Link href={"/"} className=' text-2xl md:text-3xl text-white font-semibold px-20 py-5'> Logo </ Link>
           ...
           <div className='menu hidden md:block md:w-auto' id='navbar'>
            <ul className='flex p-4 md:p-0 md:flex-row md:space-x-8 mt-10 px-4'>
        ...
        {navbarOpen ? <MenuOvarlay links={navLinks}/> :null }
    </nav>
  )
}
